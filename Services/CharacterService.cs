...
namespace dotnet_rpg.Services
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<List<GetCharacterDto>>> GetAllCharacters()
        {
            ...
            List<Character> dbCharacters = GetUserRole().Equals("Admin") ? await _context.Characters.ToListAsync() : await _context.Characters.Where(x => x.User.Id == GetUserId()).ToListAsync();
